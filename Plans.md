...
**推奨着手順**: 4.1 → 4.4 → 4.2 → 4.5 まで完了（2026-07-05）。**残り: 4.3（公開ケースでの継続 recall 計測）→ 4.6（Artifact 2 本立て反映）**。4.3 は 4.2 完了により着手可能、4.6 は 4.5 完了により残り依存は 4.1（完了）のみ＝着手可能だが 4.3 の公開 recall を反映してからが望ましい。
