...
詳細: [docs/operations.md](docs/operations.md)（モデル・レビュー・マージ方針） / [docs/role-division.md](docs/role-division.md) / [docs/breezing-safety.md](docs/breezing-safety.md) / [docs/pr-review-loop-metrics.md](docs/pr-review-loop-metrics.md)（自動マージ昇格判断） / [docs/quality-baseline/README.md](docs/quality-baseline/README.md) / [docs/wt-parallel.md](docs/wt-parallel.md)（worktree 並列開発ツール導入）
